...
// Always populated by Wait(), even when Wait returns an error.
type Result struct {
...
// BufferedResult extends Result with captured stdout and stderr content.
// Returned by [Executor.RunBuffered] and [Executor.RunShell].
